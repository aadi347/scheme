...
const NewForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setIsRightBarActive(true); // Activate the right bar on form submit
  };
    ...
    <>
      ...
      <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
        <motion.div
          ...
          initial={{ x: 0 }}
          animate={{ x: isRightBarActive ? -150 : 0 }}
          transition={{ type: "spring", stiffness: 100, damping: 30 }}
        >
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-gradient-to-tl from-blue-600 to-violet-600 py-10 px-10">
              {/* SVG Image */}
