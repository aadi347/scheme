...
<div className="bg-white grid grid-cols-6 gap-2 rounded-xl p-2 text-sm  border border-gray-200">
    <h1 className="text-center text-gray-600 text-xl font-bold col-span-6">Send Feedback</h1>
