          ...
          <tbody>
            {schemes.map((scheme) => (
              <tr key={scheme.id} className="border-b hover:bg-gray-100">
                ...
                <td>
                    <button
                     onClick={handleApllyButtonClick}
                     className="text-indigo-500 px-4 text-xs font-semibold border bg-gray-200 border-gray-400 py-1 rounded-full">Apply</button>
                </td>
              </tr>
            ))}
          </tbody>
